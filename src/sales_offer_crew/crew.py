...
class SalesOfferCrew:
    """SalesOfferCrew for generating personalized sales offers based on customer data"""
    ...
    # Common tools that will be available to all agents
    common_tools = [AirtableTool()]
    ...
    @crew
    def crew(self) -> Crew:
        """Creates the SalesOfferCrew crew for generating personalized sales offers"""
